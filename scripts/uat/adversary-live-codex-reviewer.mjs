...
export function buildAdversaryLiveReviewerPrompt(input) {
  ...
  return [
    ...
    'The selected patch also changes src/profile.cjs canViewProfile from always-true to public/private/adminOnly visibility semantics.',
    'A useful proposal should exercise cart semantics, including quantity > 1, quantity: 0, discount, tax, or cent rounding, or profile visibility semantics including private owner/admin and adminOnly, so the buggy base fails and the selected candidate passes.',
