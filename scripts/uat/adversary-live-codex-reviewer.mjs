...
export function buildAdversaryLiveReviewerPrompt(input) {
  ...
  return [
    ...
    'A useful proposal should exercise cart semantics, including quantity > 1, quantity: 0, discount, tax, or cent rounding, so the buggy base fails and the selected candidate passes.',
