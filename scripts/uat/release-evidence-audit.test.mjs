...
function skillPromptCorpusLiveLedger(overrides = {}) {
  const userIssueCount = overrides.userIssueCount ?? 16;
  const autoDiscoveryCount = overrides.autoDiscoveryCount ?? 16;
  const githubDraftPr = overrides.githubDraftPr === true;
  const variants = [
      ...
      expect.objectContaining({
        ...
        ledger_summary: expect.objectContaining({
          ...
          prompt_corpus: expect.objectContaining({
            requested_variant_count: 32,
            executed_variant_count: 32,
            passed_variant_count: 32,
            failed_variant_count: 0,
            blocked_variant_count: 0
          }),
  ...
  it('keeps targeted existing business-source repair audit explicit', async () => {
    ...
    expect(selected).toEqual([
      expect.objectContaining({
        ...
        expected_ledger: {
          min_cell_count: 18,
          min_pass_count: 18,
          min_distinct_semantic_target_count: 18,
          max_fail_count: 0,
          required_codex_repair_smoke: true,
    ...
    await writeLedger(root, scenario, 'business-source-repair-run', {
      ...
      cells: [
        ...
        {
          id: 'warehouse-inventory-project',
          status: 'pass',
          codex_repair: {
            status: 'pass',
            business_source_repair: true,
            ...
            semantic_target_id: 'warehouse-inventory-reserved-stock',
            existing_source: true,
            repair_source:
        ...
        },
        {
          ...
          codex_repair: {
            ...
            semantic_target_id: 'data-retention-legal-hold',
            existing_source: true,
            repair_source:
        ...
        },
        {
          ...
          codex_repair: {
            ...
            semantic_target_id: 'payment-settlement-authorization-gate',
            existing_source: true,
            repair_source:
              'examples/business-source/payment-settlement-capture.cjs',
            visible_acceptance: { status: 'pass' },
            hidden_acceptance: { status: 'pass' },
            diff_scope: { status: 'pass' },
            source_changed: true,
        ...
        },
        {
          ...
          codex_repair: {
            ...
            semantic_target_id: 'tax-filing-backup-withholding',
            existing_source: true,
            repair_source: 'examples/business-source/tax-filing-compliance.cjs',
            visible_acceptance: { status: 'pass' },
            hidden_acceptance: { status: 'pass' },
            diff_scope: { status: 'pass' },
            source_changed: true,
        ...
        },
        {
          ...
          codex_repair: {
            ...
            semantic_target_id: 'vendor-invoice-po-approval',
            existing_source: true,
            repair_source:
              'examples/business-source/vendor-invoice-approval.cjs',
            visible_acceptance: { status: 'pass' },
            hidden_acceptance: { status: 'pass' },
            diff_scope: { status: 'pass' },
            source_changed: true,
        ...
        },
        {
          ...
          codex_repair: {
            ...
            semantic_target_id: 'release-readiness-sev1-hold',
            existing_source: true,
            repair_source: 'examples/business-source/release-readiness.cjs',
            visible_acceptance: { status: 'pass' },
            hidden_acceptance: { status: 'pass' },
            diff_scope: { status: 'pass' },
            source_changed: true,
