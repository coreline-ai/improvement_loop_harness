...
- 🚧 **남은 작업** — 임의/대형 실제 프로젝트의 기존 업무 source-code repair + PR corpus, profile visibility 이후 더 큰 project-specific semantic/M4 corpus, `P4 Real Reviewer Live Evidence` workflow의 실제 credentialed CI PASS, CI artifact 기반 장기 감사.
