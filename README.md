...
- 🚧 **남은 작업** — Product-100 controlled corpus 밖의 임의/대형 실제 프로젝트 corpus, 더 큰 project-specific semantic/M4 corpus, real Codex adversary reviewer lane의 CI artifact 재현성, CI artifact 기반 장기 감사.
