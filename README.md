...
corepack pnpm uat:repo-matrix:real-project-semantic-source-repair -- --repo <repo-a> --repo <repo-b> --repo <repo-c> --repo <repo-d> --repo <repo-e> --repo <repo-f> --min-repos 6 # P5 실제 repo curated semantic 기존 source repair + hidden verifier
