...
- 🚧 **남은 작업** — Product-100 controlled corpus 밖의 임의/대형 실제 프로젝트 corpus, real Codex adversary reviewer generation live lane, 더 큰 project-specific semantic/M4 corpus, CI artifact 기반 장기 재현성 감사.
