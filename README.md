...
- 🚧 **남은 작업** — 임의/대형 실제 프로젝트의 기존 업무 bug repair corpus, profile suspension 이후 더 큰 project-specific semantic/M4 corpus, CI artifact 기반 장기 감사. R27/R28/R29 existing-source repair용 opt-in CI artifact workflow와 R30/R31 P4 6-rule semantic/M4 local+credentialed CI evidence는 추가됐지만, broad real-project 업무 bug corpus와 더 큰 project-specific semantic/M4 corpus는 아직 후속이다.
